            ...
            <form action="#" method="post" class="formulaire">
                ...
                if (isset($_GET['recordID'])) {
                    ...
                    while ($rowrdv = $records->fetch()) {
                        ...
                        <div class="user-box">
                            <input type="datetime-local" name="dateheure" value="<?php echo $rowrdv["DateHeureRDV"] ?>"
                                required="">
                        </div>
                        <label>Durée</label>
                        <div class="user-box">
                            <input type="number" name="duree" value="<?php echo $rowrdv["DuréeRDV"] ?>" min="30" max="60"
                                step="5" required="">
